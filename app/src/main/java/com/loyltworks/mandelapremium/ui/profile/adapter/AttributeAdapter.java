...
public class AttributeAdapter extends ArrayAdapter<LstAttributesDetail> {
    private Context context;
    private ArrayList<LstAttributesDetail> locationStateCities;


    public AttributeAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<LstAttributesDetail> location) {
